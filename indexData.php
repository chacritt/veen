...
if (isset($_POST['book_name'])) {
  $colname_Recordset1 = $_POST['book_name'];
}
mysql_select_db($database_db_conn, $db_conn);
$query_Recordset1 = sprintf("SELECT * FROM book WHERE name LIKE %s", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
...
<form id="form1" name="form1" method="post" action="">
  <p>
    <label for="findBook">กรุณากรอกชื่อหนังสือที่ต้องการค้นหา : </label>
  ...
  <table width="933" border="0">
    ...
    <tr>
      <td colspan="2"><?php echo $row_Recordset1['id']; ?></td>
...
<table border="1">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php if($row_Recordset2['status'] == 0){echo "ว่าง";}else if($row_Recordset2['status'] == 1){echo "ยืม";} ?></td>
    </tr>
    <?php } while ($row_Recordset2 = mysql_fetch_assoc($Recordset2)); ?>
</table>
<p>&nbsp;<a href="<?php echo $logoutAction ?>">ออกจากระบบ</a></p>
</body>
</html>
<?php
