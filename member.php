...
<form id="form1" name="form1" method="post" action="memberSearch.php">
  ...
  <table width="360" border="0">
    ...
    <tr>
      ...
      <input type="password" name="password" id="password" readonly/></td>
    </tr>
    <tr>
      <td> ชื่อ-สกุล :</td>
    ...
    <tr>
      ...
      <input type="text" name="class" id="class" readonly/></td>
    </tr>
    <tr>
      <td>ที่อยู่ :</td>
    ...
    <tr>
      ...
      <input type="text" name="status" id="status" readonly/></td>
    </tr>
  </table>
</form>
<button>เพิ่ม</button>
